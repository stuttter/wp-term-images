 ...
 */
	 ...
	 */
		public function enqueue_scripts() {
			...
			// Localize
			wp_localize_script(
				'wp-term-images', 'i10n_WPTermImages', array(
	 ...
	 */
		protected function form_field( $term = '' ) {
			...
			<div>
				<img id="wp-term-images-photo" src="<?php echo esc_url( wp_get_attachment_image_url( $value, 'full' ) ); ?>" style="<?php echo esc_attr( $hidden ); ?>" />
			...
			<a href="<?php echo esc_url( $remove_url ); ?>" class="button wp-term-images-remove" style="<?php echo esc_attr( $hidden ); ?>">
