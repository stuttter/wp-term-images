...
jQuery( document ).ready(
	function( $ ) {
		 ...
		 */
			.on(
				'click', '.wp-term-images-media', function ( event ) {
		 ...
		 */
			.on(
				'click', '.wp-term-images-remove', function ( event ) {
